        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input id="name" name="name" required className="bg-gray-700 text-gray-100 border-gray-600 focus:ring-violet-500" />
            </div>
            <div>
              <Label htmlFor="admnNo" className="text-gray-300 block mb-1">Admission Number</Label>
              <Input id="admnNo" name="admnNo" required className="bg-gray-700 text-gray-100 border-gray-600 focus:ring-violet-500" />
            </div>
            <div>
              <Label htmlFor="email" className="text-gray-300 block mb-1">Email Address</Label>
              <Input id="email" name="email" type="email" required className="bg-gray-700 text-gray-100 border-gray-600 focus:ring-violet-500" />
            </div>
            <div>
              <Label htmlFor="phNo" className="text-gray-300 block mb-1">Phone Number</Label>
              <Input id="phNo" name="phNo" type="tel" required className="bg-gray-700 text-gray-100 border-gray-600 focus:ring-violet-500" />
            </div>
            <div>
              <Label htmlFor="projectLink" className="text-gray-300 block mb-1">Project Repository (GitHub)</Label>
              <Input id="projectLink" name="projectLink" type="url" required className="bg-gray-700 text-gray-100 border-gray-600 focus:ring-violet-500" />
            </div>
          </div>
          ...
          {(role === 'ai_dev' || role === 'frontend_dev') && (
            ...
            >
              ...
              <Input id="deployedLink" name="deployedLink" type="url" className="bg-gray-700 text-gray-100 border-gray-600 focus:ring-violet-500" />
            </motion.div>
          )}
        ...
        {submitResult && (
          <motion.div
            ...
            className={`mt-6 p-4 rounded-md ${
              submitResult.success ? 'bg-green-800 text-green-100' : 'bg-red-800 text-red-100'
            }`}
          >
