    ...
    return (
        <Card className="w-full max-w-2xl bg-gray-800 text-gray-100 shadow-2xl">
            <CardHeader className="bg-gradient-to-r from-purple-600 to-violet-600 rounded-t-lg p-6 space-y-2">
                ...
                <CardDescription className="text-gray-200 text-center italic"> Everything You Can Imagine Is Real </CardDescription>
            </CardHeader>
            <CardContent className="p-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-4">
                        ...
                        <div>
                            <Label htmlFor="admnNo" className="text-gray-300 block mb-1">Register Number</Label>
                        ...
                        <div>
                            ...
                            <Input id="phNo" name="phNo" type="tel" required autoComplete="tel" className="bg-gray-700 text-gray-100 border-gray-600 focus ```tsx
:ring-violet-500" />
                        </div>
                        <div>
                    ...
                    {submitResult && (
                        <div className={`text-center mt-4 ${submitResult.success ? 'text-green-500' : 'text-red-500'}`}>
